 ...
 * @author Mihika
 */
class DialogActiveCashier extends JDialog implements ActionListener, ItemListener{
    Shop shop;
     JButton buttonOK; 
   ...
   JComboBox comboBoxWorker = new JComboBox();
    ...
    Cashier cashTemp;   
    public DialogActiveCashier(Shop shop){
        Dimension size;
      ...
      labelWorker=new JLabel("Cashier            ");
      ...
      String line;
      int i=0;
      this.cashierList=shop.cashierList;
      
           while(i<cashierList.size()){
               cashTemp=cashierList.get(i);
               line=cashTemp.getName_worker();
...
if(e.getActionCommand()=="OK")
            {
                ...
                String CashierName=result.toString();
                shop.SetActiveCashier(CashierName);
            }
              dispose();      }
