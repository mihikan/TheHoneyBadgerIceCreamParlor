...
public class DialogStockerOnBreak extends JDialog implements ActionListener {
    JButton buttonOK;
    JButton buttonYES;
   ...
   public DialogStockerOnBreak(Shop shop){
       this.shop=shop;
      Dimension size;
      ...
      this.setTitle("Stocker on Break");       
      ...
      labelProject=new JLabel(shop.Stocker());
      if(shop.StockerOnBreak()){
          label2=new JLabel("is on Break");
          label3=new JLabel("Select another stocker");
